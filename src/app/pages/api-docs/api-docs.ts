...
export class ApiDocsPage {
  ...
  codeExamples = {
    curl: `curl -X GET "https://api.dataencuesta.com/v1/surveys" \\
  -H "Authorization: Bearer YOUR_API_KEY" \\
  -H "Content-Type: application/json"`,
    js: `const response = await fetch('https://api.dataencuesta.com/v1/surveys', {
  headers: {
...
url = "https://api.dataencuesta.com/v1/surveys"
