...
export class SurveyMapperService {
  ...
  private mapQuestion(question: NonNullable<SurveyRow['preguntas']>[number]): Question {
    return {
      ...
      metaConfig: question.metadatos?.metaConfig,
      titleConfig: question.metadatos?.titleConfig,
      helpConfig: question.metadatos?.helpConfig,
      answerConfig: question.metadatos?.answerConfig,
